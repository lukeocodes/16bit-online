...
7. **Equipment/inventory/loot** — Server done (2550494): DB schema, inventory.ts, loot-on-kill, load/save lifecycle. Client receives drops in chat. Still needs: inventory UI panel, equip/unequip handler, stat bonuses applied to combat.
