...
12. **Quest system** — DONE (160c232). 5 kill quests across zones. Accept/progress/turn-in with XP+item rewards. Still needs: client quest UI panel, quest giver NPCs.
